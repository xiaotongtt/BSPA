...
import torch.nn as nn
from model import edsr_baseline, rcan, swinir, nlsn
import numpy as np
...
class Trainer():
    ...
    def search_filter_index(self, sorted_filter_location, epoch):
        ...
        N = round(remain_factor * len(indexs))  # 0.9
    ...
    def extract_index(self, epoch, target_model_path, baseline_model_path):
        ...
        save_noisy_filter_txt = os.path.join(self.args.record_filters_folder,
                                             'IG_index_weight_un'+str(self.args.un_factor)+'_edsr_' + str(epoch) + '.txt')
    ...
    def inverse_sampling(self, epoch):
        ...
        # baseline_model_path = '../experiment/EDSR/EDSR_x4_WA_IG_un100_Sy7/model/model_latest.pt'
